...
# -*- coding: utf-8 -*-
"""
Created on Thu May 14 14:50:08 2020
...
class BaseDataProvider(object):
    ...
    def __call__(self, nbatch):
        ...
        # allocate memory
        # we concatenated the Ntime with nbatches due to the inability of
...
class ImageDataProvider(BaseDataProvider):
    ...
    def __init__(self, search_path, nchannels=1, mysize=None, Ntime=9, downscaling=2, test=False, \
        ...
        self.Ntime = Ntime # corresponds to Nz!
    ...
    def _simulate_microscope(self, data):
        ...
        myresultframe_clean = np.zeros((self.mysize[0]//self.downscaling, self.mysize[1]//self.downscaling, self.Ntime))
        # iterate over all frames


        for iframe in range(self.Ntime):
            # generate illumination pattern by randomly selecting illumination frames
            myillutmp = self.myallilluframes[:,:,np.random.randint(0, self.Ntime)]
