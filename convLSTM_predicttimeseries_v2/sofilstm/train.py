...
class trainer_sofi(object):
    ...
    def __init__(self, net, batch_size=1, ntimesteps = 9, optimizer="adam", opt_kwargs={}):
        self.net = net
    ...
    def train(self, data_provider, output_path, valid_provider, valid_size, training_iters=100, epochs=1000, dropout=0.75, display_step=1, save_epoch=50, restore=False, write_graph=False, prediction_path='validation'):
        ...
        with tf.compat.v1.Session(config=config) as sess:
            ...
            if write_graph:
                tf.io.write_graph(sess.graph_def, output_path, "graph.pb", False)
            ...
            for epoch in range(epochs):
                ...
                self.output_valstats(sess, data_provider, summary_writer, step, valid_x, valid_y, "epoch_%s"%epoch, store_img=True)
    ...
    def output_minibatch_stats(self, sess, data_provider, summary_writer, step, batch_x, batch_y):
        ...
        summary_writer.add_summary(summary_str, step) # add the images to Tensorboard
