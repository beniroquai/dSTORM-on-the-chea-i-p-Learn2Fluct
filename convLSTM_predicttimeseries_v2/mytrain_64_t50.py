...
nn_name = 'upsamping_4_plusmean_noconv'
...
if platform == "linux" or platform == "linux2":
	train_data_path = './data/data_downconverted' # linux
elif platform == "darwin":
	train_data_path = './data/test' # OS X
elif platform == 'win32':
   train_data_path = '.\\data\\data_downconverted_4'; upscaling=4
