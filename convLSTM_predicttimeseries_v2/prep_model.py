...
model_dir = './upsamping_4_gpu0,1/models/final/'
...
with tf.io.gfile.GFile(absolute_model_dir+'/'+'frozen_model.pb', "rb") as f:
    data2read = f.read()
...
f = tf.compat.v1.gfile.FastGFile(absolute_model_dir+'/'+"outputOptimizedGraph.pb", "w")
